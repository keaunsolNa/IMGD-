...
public class KakaoOauth implements SocialOauth {
	...
	public String getOauthRedirectUrl() {
		...
		return kakaoBaseUrl + "?response_type=code&client_id=" + kakaoClientId + "&redirect_uri="
			+ kakaoCallbackUrl;
	}
	...
	public String requestAccessToken(String code) {
		...
		params.put("grant_type", kakaoGrantType);
		...
		try {
			ResponseEntity<String> responseEntity = restTemplate.postForEntity(kakaoTokenUri, requestEntity,
				String.class);

...
public class GoogleOauth implements SocialOauth {
	...
	public String getOauthRedirectUrl() {
		...
		return googleBaseUrl + "?" + parameterString;
	}
	...
	public String requestAccessToken(String code) {
		...
		form.add("redirect_uri", googleCallbackUrl); // authorize 때와 1글자도 동일해야 함
		form.add("grant_type", googleGrantType); // authorization_code
		//
		// Map<String, Object> params = new HashMap<>();
		...
		try {
			...
			ResponseEntity<String> res = restTemplate.postForEntity(googleTokenUrl, req, String.class);
	...
	public String[] requestUserInfo(String accessToken) {
		...
		try {
			...
			// GET 요청 전송
			ResponseEntity<String> responseEntity = restTemplate.exchange(googleUserInfoUri, HttpMethod.GET,
